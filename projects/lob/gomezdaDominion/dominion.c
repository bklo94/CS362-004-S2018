...
void rAdventurer(struct gameState *state, int z, int temphand[], int currentPlayer)
{
      int drawntreasure=0;
...
void rSmithy(int currentPlayer, struct gameState *state, int handPos){
...
void rCouncil_room(struct gameState *state, int handPos, int currentPlayer)
{
...
void feastCard(int currentPlayer, struct gameState *state, int temphand[], int choice1){
   int i,x;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus){
   ...
   switch( card ){
      case adventurer:
         rAdventurer(state, z, temphand, currentPlayer);
         return 0;
      ...
      case smithy:
         rSmithy(currentPlayer, state, handPos);
         return 0;
